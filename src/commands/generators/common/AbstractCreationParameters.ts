...
import { GeneratorConfig, SemVerRegExp } from "@atomist/sdm";
...
/**
 * Superclass for project generator parameters.
 */
@Parameters()
export abstract class AbstractCreationParameters implements SeedDrivenGeneratorParameters {
